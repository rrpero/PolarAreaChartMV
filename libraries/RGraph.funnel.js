    ...
    */
    RGraph.Funnel = function (conf)
    {
        ...
        */
        ...
        {
            var width     = (ca.width - this.gutterLeft - this.gutterRight)/prop['chart.width'];
            ...
            */
            ...
            for (i=0,len=this.data.length; i<len; ++i) {
                ...
                var firstwidth = (firstvalue / total) * (width*prop['chart.width']);
                ...
                var center        = this.gutterLeft + (firstwidth / 2)+prop['chart.funnel.horizontal'];
    
                var x1 = center - (halfCurWidth)*1;
                var y1 = accheight;
                var x2 = center + (halfCurWidth)*1;
                var y2 = accheight;
                var x3 = center + (halfNextWidth)*1;
                var y3 = accheight + curheight;
                var x4 = center - (halfNextWidth)*1;
